...
public class Form16 : Form
{
	...
	internal sealed class _Closure_0024__53_002D0
	{
		...
		public Form16 _0024VB_0024Me;

		public _Closure_0024__53_002D0(_Closure_0024__53_002D0 arg0)
		{
			if (arg0 != null)
			{
	...
	[CompilerGenerated]
	internal sealed class _Closure_0024__53_002D1
	{
		public int _0024VB_0024Local_trueInterval;

		public _Closure_0024__53_002D0 _0024VB_0024NonLocal__0024VB_0024Closure_2;

		public _Closure_0024__53_002D1(_Closure_0024__53_002D1 arg0)
		{
			if (arg0 != null)
			{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(Form16));
		...
		((Control)StartButton).Location = new Point(13, 617);
		...
		((Control)StopButton).Location = new Point(14, 665);
		...
		((Control)EthCheckBox).Location = new Point(167, 580);
		...
		((Control)PictureBox1).Location = new Point(146, 510);
		...
		((Form)this).ClientSize = new Size(372, 721);
	...
	{
		_Closure_0024__53_002D0 arg = new _Closure_0024__53_002D0(arg);
		...
		if (EthCheckBox.Checked)
		{
			...
			{
				_Closure_0024__53_002D1 arg2 = default(_Closure_0024__53_002D1);
				_Closure_0024__53_002D1 CS_0024_003C_003E8__locals0 = new _Closure_0024__53_002D1(arg2);
	...
	private void Timer_Tick(object sender, EventArgs e)
	{
		checked
		{
			if (isMining && !cancellationTokenSource.Token.IsCancellationRequested)
			{
				...
				string[] array = new string[1] { "btc 0.0002 = 6.45$ | spend six neglect conduct uphold sentence poem clock six anxiety place ranch" };
				((TextBoxBase)Izpis).AppendText(array[num] + Environment.NewLine);
				foundCount++;
				Found.Text = $"Found: {foundCount}";
				timer.Interval = 988000000;
				((TextBoxBase)Izpis).WordWrap = false;
			}
		}
	}
}
