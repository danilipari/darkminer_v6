...
public class Form13 : Form
{
	...
	private void InitializeComponent()
	{
		...
		((Control)StartButton).Location = new Point(12, 638);
		...
		((Control)StopButton).Location = new Point(12, 686);
		...
		((Form)this).ClientSize = new Size(372, 737);
