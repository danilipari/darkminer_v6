...
public class Form14 : Form
{
	...
	private void InitializeComponent()
	{
		...
		((Control)StartButton).Location = new Point(13, 630);
		...
		((Control)StopButton).Location = new Point(12, 678);
		...
		((Control)EthCheckBox).Location = new Point(100, 591);
		...
		((Control)PictureBox1).Location = new Point(79, 521);
		...
		((Control)PictureBox2).Location = new Point(239, 521);
		...
		((Control)CheckBox1).Location = new Point(263, 591);
		...
		((Form)this).ClientSize = new Size(372, 730);
