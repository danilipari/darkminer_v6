...
public class Form5 : Form
{
	...
	private void InitializeComponent()
	{
		...
		((Control)PictureBox3).Location = new Point(100, 630);
		...
		((Control)PictureBox4).Location = new Point(214, 630);
		...
		((Control)CheckBox3).Location = new Point(123, 700);
		...
		((Control)CheckBox4).Location = new Point(239, 700);
