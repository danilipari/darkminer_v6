...
public class Form15 : Form
{
	...
	private void InitializeComponent()
	{
		...
		((Control)StopButton).Location = new Point(12, 665);
		...
		((Control)EthCheckBox).Location = new Point(183, 580);
		...
		((Control)PictureBox1).Location = new Point(161, 510);
		...
		((Form)this).ClientSize = new Size(372, 720);
