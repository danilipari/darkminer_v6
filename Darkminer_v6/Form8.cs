...
{
	[CompilerGenerated]
	internal sealed class _Closure_0024__61_002D0
	{
		public string _0024VB_0024Local_selectedCrypto;

		public Form8 _0024VB_0024Me;

		public _Closure_0024__61_002D0(_Closure_0024__61_002D0 arg0)
		{
			if (arg0 != null)
			{
	...
	private void InitializeComponent()
	{
		...
		((Control)StartButton).Location = new Point(13, 629);
		...
		((Control)StopButton).Location = new Point(14, 677);
		...
		((Control)EthCheckBox).Location = new Point(109, 591);
		...
		((Control)PictureBox1).Location = new Point(86, 521);
		...
		((Control)PictureBox2).Location = new Point(234, 521);
		...
		((Control)CheckBox1).Location = new Point(259, 591);
		...
		((Form)this).ClientSize = new Size(372, 729);
	...
	{
		_Closure_0024__61_002D0 arg = default(_Closure_0024__61_002D0);
		_Closure_0024__61_002D0 CS_0024_003C_003E8__locals0 = new _Closure_0024__61_002D0(arg);
		...
		{
			CS_0024_003C_003E8__locals0._0024VB_0024Local_selectedCrypto = "BTC";
			bool flag = false;
		...
		{
			MessageBox.Show("Please select all blockchains.", "Invalid Blockchain", (MessageBoxButtons)0, (MessageBoxIcon)16);
		}
	}
